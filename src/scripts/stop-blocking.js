...
$(document).ready(function () {
	...
	var arrayHeader=fullMenu.split(",");
	$.each(arrayHeader,function(i){
		var m=arrayHeader[i].trim();
		$('#'+m).css('display','block');
	});
	...
	$("input[name=theme]").click(function (event) {
		$(".light").show();
		$(".dark").hide();
		return false;
		});
 ...
 function homePage(){
	 	/* $("#form_MainMenuPage").attr("action",contextPath+"/Home.action");
...
function AgricultureCensusPage(){
 ...
 function challanGeneratePage(){
	 if(user==''){		
			$.post("putTargetMenuActionName.action",{message:"challanGenerate",
				ajax : 'true'},function(data){},"json");				
				$.post('viewLoginAreaAction',
						function(html) {										
				...
				$("#form_MainMenuPage").attr("action",contextPath+"/challanGenerate.action");
				$("#form_MainMenuPage").submit();
			}
 ...
 function challanReprintPage(){		
	 if(user==''){		
			$.post("putTargetMenuActionName.action",{message:"challanReprint",
				ajax : 'true'},function(data){},"json");				
				$.post('viewLoginAreaAction',
						function(html) {										
							$('#login-modal .loginmodal-container').html(html);	
				...
				$("#form_MainMenuPage").attr("action",contextPath+"/challanReprint.action");
				$("#form_MainMenuPage").submit();
			}
...
function knowYourPropertyPage(){
	 if(user==''){		
			$.post("putTargetMenuActionName.action",{message:"KnowYourProperty",
				ajax : 'true'},function(data){},"json");				
				$.post('viewLoginAreaAction',
						function(html) {										
							$('#login-modal .loginmodal-container').html(html);	
				...
				$("#form_MainMenuPage").attr("action",contextPath+"/KnowYourProperty.action");
				$("#form_MainMenuPage").submit();
			}
...
function serviceStatusLocWise(){
	if(user==''){		
	$.post("putTargetMenuActionName.action",{message:"SerivceStatusLocationWise",
		ajax : 'true'},function(data){},"json");				
		$.post('viewLoginAreaAction',
				function(html) {										
					$('#login-modal .loginmodal-container').html(html);	
		...
		beforeLoginModal.style.display = "none";					
 		...
 		$("#form_MainMenuPage").attr("action",contextPath+"/SerivceStatusLocationWise.action");
		$("#form_MainMenuPage").submit();
	}
	}
 ...
 function MuteApplicationPage(){		
	 if(user==''){			
		$.post("putTargetMenuActionName.action",{message:"MuteApplication",
			ajax : 'true'},function(data){},"json");
			...
			// document.getElementById("signIn").click();			
	 		...
	 		$("#form_MainMenuPage").attr("action",contextPath+"/MuteApplication.action");
			$("#form_MainMenuPage").submit();
		}
	}		
	function RORReqPage(){
		if(user==''){			
		$.post("putTargetMenuActionName.action",{message:"RORReq",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
 ...
 function PIReqPage(){		
	 if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"PIReq",
				ajax : 'true'},function(data){},"json");				
				$.post('viewLoginAreaAction',
						function(html) {										
							$('#login-modal .loginmodal-container').html(html);	
 ...
 function PlotMapReqPage(){		
	 if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"PlotMapReq",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
 ...
 function MouzaMapReqPage(){	
	 if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"MouzaMapReq",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
 ...
 /* function RsMapReqPage(){		
		$("#form_MainMenuPage").attr("action",contextPath+"/RsMapReq.action");
		$("#form_MainMenuPage").submit();		
 } */
 function MouzaMapAvailabilityPage(){	
	 if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"MouzaMapAvailabilityReq",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			$("#form_MainMenuPage").attr("action",contextPath+"/MouzaMapAvailabilityReq.action");
			$("#form_MainMenuPage").submit();	
		}
 }

	/* function grnsearchPageAppln(){
	 	$("#form_MainMenuPage").attr("action",contextPath+"/grnsearchAppln.action");
		$("#form_MainMenuPage").submit();
	} */
	function revenueApplicationPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"RevenueApplication",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			$("#form_MainMenuPage").attr("action",contextPath+"/RevenueApplication.action");
			$("#form_MainMenuPage").submit();
		}
	}
	function revenueApplicationListPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"RevenueApplicationList",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			$("#form_MainMenuPage").attr("action",contextPath+"/RevenueApplicationList.action");
			$("#form_MainMenuPage").submit();
		}
	}
	...
	function revenueNoDueCertificatePage(){		
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"RevenueNoDueCertificate",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			$("#form_MainMenuPage").attr("action",contextPath+"/RevenueNoDueCertificate.action");
			$("#form_MainMenuPage").submit();
		}
	}
	...
	function privateAminApplicationPage(){		
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"PrivateAminApplication",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			$("#form_MainMenuPage").attr("action",contextPath+"/privateAminApplicationPage.action");
			$("#form_MainMenuPage").submit();
		}
	}
	...
	function privateAminRegistrationPage(){		
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"PrivateAminRegistration",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			$("#form_MainMenuPage").attr("action",contextPath+"/privateAminRegistrationPage.action");
			$("#form_MainMenuPage").submit();
		}
	}
 ...
 /*	function revenueModificationPage(){
	 	$.post("sessionRemove.action",{message:urlKhajna,
			ajax : 'true'},
						function(data){
				if(data.message!='OK'){
					$("#input_val").val(data.message);
				}
		 	$("#form_MainMenuPage").attr("action",khajnaUrl+"/revenueModificationAction.action");
			$("#form_MainMenuPage").submit();
		}"json");
	} */
	...
	/* function grnsearchPageService(){
	 	$("#form_MainMenuPage").attr("action",contextPath+"/grnsearchService.action");
		$("#form_MainMenuPage").submit();
	} */

	function Apprec_rep(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"Apprecrep",
				ajax : 'true'},function(data){},"json");				
				$.post('viewLoginAreaAction',
						function(html) {										
							$('#login-modal .loginmodal-container').html(html);	
	...
	function FeesCollectionPage(applicationNo){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"FeesCollection",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			beforeLoginModal.style.display = "none";					
			 ...
			 if(applicationNo =="")
			 	$("#form_MainMenuPage").attr("action",contextPath+"/FeesCollection.action");
				else
			 	$("#form_MainMenuPage").attr("action",contextPath+"/FeesCollection.action?applnNo=" + applicationNo);
				$("#form_MainMenuPage").submit();
		}
		
		/* $.post("sessionRemove.action",{message:urlMain,
				ajax : 'true'},
							function(data){
					if(data.message!='OK'){
						$("#input_val").val(data.message);
					 ...
					 if(applicationNo ==""){		
							$("#form_MainMenuPage").attr("action",mainUrl+"/FeesCollection.action");
					 }else{
						 $("#form_MainMenuPage").attr("action",mainUrl+"/FeesCollection.action?applnNo=" + applicationNo);
					 }
				$("#form_MainMenuPage").submit();
			},"json");*/
	}
	...
	function muteStatusPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"MuteStatus",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
	...
	function convStatusPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"ConvStatus",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
	...
	function warishStatusPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"WarishStatus",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			beforeLoginModal.style.display = "none";					
		 	...
		 	$("#form_MainMenuPage").attr("action",contextPath+"/WarishStatus.action");
			$("#form_MainMenuPage").submit();
		}
	}
	function plotKhatianStatusPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"PlotKhatianStatus",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			beforeLoginModal.style.display = "none";					
		 	...
		 	$("#form_MainMenuPage").attr("action",contextPath+"/PlotKhatianStatus.action");
			$("#form_MainMenuPage").submit();
		}
	}	
	function rslrPlotInfoPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"RslrPlotInfo",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
			...
			beforeLoginModal.style.display = "none";					
		 	...
		 	$("#form_MainMenuPage").attr("action",contextPath+"/RslrPlotInfo.action");
			$("#form_MainMenuPage").submit();
		}
	}
	...
	function landClassPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"LandClass",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
	...
	function signedPdfPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"signedPdfList",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
	 	...
	 	$("#form_MainMenuPage").attr("action",contextPath+"/signedPdfList.action");
		$("#form_MainMenuPage").submit();
		}
	}
	...
	function convAppViewPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"ConvAppViewAction",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
	 	...
	 	$("#form_MainMenuPage").attr("action",contextPath+"/ConvAppViewAction.action");
		$("#form_MainMenuPage").submit();
		}
	}
	function warishAppViewPage(){
		if(user==''){			
			$.post("putTargetMenuActionName.action",{message:"WarishAppViewAction",
			ajax : 'true'},function(data){},"json");				
			$.post('viewLoginAreaAction',
					function(html) {										
						$('#login-modal .loginmodal-container').html(html);	
	 	...
	 	$("#form_MainMenuPage").attr("action",contextPath+"/WarishAppViewAction.action");
		$("#form_MainMenuPage").submit();
		}
	}	
...
function querySearchPage(){
 ...
 function pripol(){
	 	/* $("#form_MainMenuPage").attr("action",contextPath+"/privacypolicy.action");
		$("#form_MainMenuPage").submit(); */
...
function searchActionChange(){
	var functionChange = $(".search_select").val();
	eval(functionChange + "()");
}
	 ...
	 /*$.post("sessionRemove.action",{message:urlMain,
			ajax : 'true'},
				...
				if(data.message!='OK'){
					...
					$("#form_MainMenuPage").attr("action",mainUrl+"/BrickFieldFeesCollection");					
					$("#form_MainMenuPage").submit();
		},"json");*/
...
if(user==''){
	$.post("putTargetMenuActionName.action",{message:"appGrnSrch",
		ajax : 'true'},function(data){},"json");				
		$.post('viewLoginAreaAction',
				function(html) {									
					$('#login-modal .loginmodal-container').html(html);	
...
$(function() {
	$(".langSaveToSession").click(function(){
		...
		$.post("addLang.action",{
			 ...
			 ajax : 'true'});//,
					//function(data){	alert('success')	},"json");
	});
});
...
function openBrkFldModal(){
	...
	$.post("distPopulateAction_KUP.action",formInput,
 				function(data){
					 var listDistItems="<option value='-1'>-----District List-----</option>";
					$.each(data.districtList,function(key, value){
						listDistItems+= "<option value='" + value.dcode + "' style='color: grey'>" +"[ "+ value.dcode+" ] "+ value.uni_dname + "</option>";
			});
...
function saveLocation(){
	...
	$.ajax({
		...
		data : { lstDistrictCodeBrkFld : $("#lstDistrictCodeBrkFld").val() },
		success : function(response, textStatus) {
				$('#brkfldmyModal').hide();
				$('#information-modal .information')
					.html("<div class='alert alert-success'><strong>"+response+"</strong></div>");
			...
			error : function(jqXHR,textStatus, exception) {
				$('#brkfldmyModal').hide();
				$('#information-modal .information')
					.html("<div class='alert alert-danger'><strong>"+exception+"</strong></div>");
				$('#information-modal').modal('show');
				$(".transparentCover").hide();
				$(".loading").hide();
			}
